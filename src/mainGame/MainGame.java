...
class GUI extends JFrame {
    ...
    public GUI() {
        ...
        // Label - oops //
        JLabel labelOops = new JLabel("Menu: ✅ Game: ❌");
        labelOops.setForeground(Color.WHITE);
        labelOops.setBounds(150, 250, 800, 100);
        labelOops.setFont(new Font("Bebas Neue", Font.BOLD, 48));
